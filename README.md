...
este servicio lo tenemos en nuestro Backend , el mismo insertar los post en nuestras bases de datos.123

solo nos resta llamar este servicio y enviarle el objeto post.
